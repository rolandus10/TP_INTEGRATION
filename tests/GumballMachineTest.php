...
class GumballMachineTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals(true,$this->gumballMachineInstance->AffichageProf("Before Insertion of Cours"));
    }
    public function testInsertC()
    {
        $max__id1=$this->gumballMachineInstance->GetLastIDC();
        $this->assertEquals('good job',$this->gumballMachineInstance->InsertC($this->intitule1,$this->duree1,$this->gumballMachineInstance->GetIdP($this->nom2,$this->prenom2)));
        $this->assertEquals('good job',$this->gumballMachineInstance->InsertC($this->intitule2,$this->duree2,$this->gumballMachineInstance->GetIdP($this->nom1,$this->prenom1)));
        $this->assertEquals('good job',$this->gumballMachineInstance->InsertC($this->intitule3,$this->duree3,$this->gumballMachineInstance->GetIdP($this->nom3,$this->prenom3)));
        $this->assertEquals('good job',$this->gumballMachineInstance->InsertC($this->intitule4,$this->duree4,$this->gumballMachineInstance->GetIdP($this->nom3,$this->prenom3)));
    ...
    {
    $this->assertEquals(true,$this->gumballMachineInstance->UpdateP($this->nom1, "NEWNAME"));
    }
    public function testUpdateC()
    {
        $this->assertEquals(true,$this->gumballMachineInstance->UpdateC($this->intitule3, "30"));
    }
    public function testDeleteC()
    {
        $this->assertEquals(true,$this->gumballMachineInstance->DeleteC($this->intitule2));
    }
